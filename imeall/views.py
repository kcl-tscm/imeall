...
# Associated with each Grain Boundary we need a calculation object
# this should have some tag i.e. DFT-vasp-PBE. So clearly a one to many
# relationship. So the tables take shape!
...
# Each CalculationTable will have its own unique tag (DFT-vasp-PBE-PAW), other parameters
# Total energy, and atoms.
# Temporary Databases
grain_boundaries = {}
calculations      = {}
#
...
calculations['1107053111'] = {'IP-EAM-MISH' : {'E0':-406.154623782, 'nat':96, 'A': 27.7436434255}}
