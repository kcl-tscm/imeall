...
if __name__=="__main__":
    ...
    parser.add_argument("--sup_cell", "-c", type=int, help="size of fe matrix super cell")
    parser.add_argument("--k", "-k", type=float, default=5.0, help="spring constant for NEB (default eV/A^2).")
   #parser.add_argument("--k", "-k", type=float, default=0.2, help="spring constant for NEB (default eV/A^2).")
    parser.add_argument("--knots", "-n", type=int, help="number of knots (images)", default=10)
    parser.add_argument("--auto_gen", "-a", action="store_true", help="For Hydrogen Paths drags H atom along a line.")
    parser.add_argument("--neb_path", "-p", nargs="+", type=float, default=[0.25, 0, -0.25])
