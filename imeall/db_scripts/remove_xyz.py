...
parser.add_argument("-rt", "--remove_type", help="rbt, structs, or traj, remove the base xyz and xyz.idx files for trajectories, base structure files or all subdirectories with rigibd body translation.")
