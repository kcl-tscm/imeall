...
class VaspOutcar(object):
  ''' 
     Small class to pull information of interest
  ...
  def write_json_file(self):
    with open('subgb.json','w') as outfile:
      ...
      A = cell[0][0]*cell[1][1]
      H = cell[2][2]
#Final energy !NOT NECESSARILY CONVERGED#
      E_cell = self.totens[-1][2]
# For legacy purposes lets always call the relaxed energy
# E_gb (for now).
      gb_dict = {'E_gb': E_cell, 
...
#REGEX library
#pull free energies, number of iterations, and whether calculation
#has converged.
...
#Set whether this particular Calculation
#has converged.
